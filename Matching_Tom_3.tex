...
\subsection{Christiano et al.'s (2016) DSGE analyses}
...
shown in our section \use{sec:FS_HagMan_simul}).
...
bargaining model: e.g., the dashed line in Figure \Fg{figMLI_CLT},
shows how unemployment becomes much less responsive to
a neutral technology shock.

In contrast, the low estimate of the value of leisure in the
...
assume that it takes one day for a wage offer to be extended,
alternatingly, by a firm and a worker.}
As expected, and in line with our analyses in sections
\use{sec:HallMilgrom} and \use{sec:FS_HallMil_simul}, the
